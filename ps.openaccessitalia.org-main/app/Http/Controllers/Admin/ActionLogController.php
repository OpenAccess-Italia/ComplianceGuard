...
class ActionLogController extends Controller
{
    ...
    public static function check_env(){
        ...
        }elseif(filter_var(env('LOGS_DAYS_ACTION'), FILTER_VALIDATE_INT, array("options" => array("min_range"=>0))) === false){
        ...
        }elseif(filter_var(env('LOGS_DAYS_AUTHENTICATION'), FILTER_VALIDATE_INT, array("options" => array("min_range"=>0))) === false){
        ...
        }elseif(filter_var(env('LOGS_DAYS_PS_API'), FILTER_VALIDATE_INT, array("options" => array("min_range"=>0))) === false){
        ...
        }elseif(filter_var(env('LOGS_DAYS_PS_API_ACCESS_TOKENS'), FILTER_VALIDATE_INT, array("options" => array("min_range"=>0))) === false){
        ...
        }elseif(filter_var(env('LOGS_DAYS_PS_API_REFRESH_TOKENS'), FILTER_VALIDATE_INT, array("options" => array("min_range"=>0))) === false){
