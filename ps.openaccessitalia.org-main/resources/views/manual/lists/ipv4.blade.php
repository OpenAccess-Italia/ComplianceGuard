    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <b>Add to IPv4s list</b>
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="value">Value</label>
                            <div class="input-group">
                                <input class="form-control" id="value" name="value" placeholder="Ex. 1.1.1.1">
                            </div>
                        </div>
            ...
            <div class="modal-body" id="modal_import_content">
                <form class="dropzone dropzone-default dropzone-primary dz-clickable mb-2" id="kt_dropzone" action="/dummy/">
                    <div class="dropzone-msg dz-message needsclick">
                        <h3 class="dropzone-msg-title">Upload text file (one IPv4 each line)</h3>
            ...
            "drawCallback": function( settings, json ) {
                ...
                $('.del').off('click').on('click',function(){
                    if(confirm('Do you want to delete this item from the list?')){
                        ...
                        $.ajax({
                            type: "GET",
                            url: '/manual/lists/ipv4/delete/'+data.ipv4,
                            statusCode: {
                                200: function(data) {
                                    table.ajax.reload();
                                },
