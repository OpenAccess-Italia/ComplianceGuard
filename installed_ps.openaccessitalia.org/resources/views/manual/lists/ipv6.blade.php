    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <b>Add to IPv6s list</b>
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="value">Value</label>
                            <div class="input-group">
                                <input class="form-control" id="value" name="value" placeholder="Ex. 2001:db8:3333:4444:5555:6666:7777:8888">
                            </div>
                        </div>
            ...
            <div class="modal-body" id="modal_import_content">
                <form class="dropzone dropzone-default dropzone-primary dz-clickable mb-2" id="kt_dropzone" action="/dummy/">
                    <div class="dropzone-msg dz-message needsclick">
                        <h3 class="dropzone-msg-title">Upload text file (one IPv6 each line)</h3>
            ...
            "drawCallback": function( settings, json ) {
                ...
                $('.del').off('click').on('click',function(){
                    if(confirm('Do you want to delete this item from the list?')){
                        ...
                        $.ajax({
                            type: "GET",
                            url: '/manual/lists/ipv6/delete/'+data.ipv6,
                            statusCode: {
                                200: function(data) {
                                    table.ajax.reload();
                                },
