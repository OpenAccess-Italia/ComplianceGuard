            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">New user</h3>
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST" id="form" action="/admin/users/add"  onsubmit="event.preventDefault();beforesubmit()">
                        @csrf
                        <div class="row">
                            <div class="col-md-9">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="name" id="name" autocomplete="none" value="" placeholder="Username">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="email" class="form-control" name="email" id="email" autocomplete="none" value="" placeholder="Email">
                                        ...
                                        <div class="form-row mt-3">
                                            <div class="col-md-2 text-center">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="piracy" name="piracy">
                                            ...
                                            <div class="col-md-2 text-center">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="cncpo" name="cncpo">
                                            ...
                                            <div class="col-md-2 text-center">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="adm" name="adm">
                            ...
                            <div class="col-md-3 text-center">
                                <div class="form-group">
                                    <label for="friendly_name">Nome</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="friendly_name" id="friendly_name" autocomplete="none" value="" placeholder="Name">
                                        <div class="input-group-append"><span class="input-group-text"><i class="fas fa-tag text-dark"></i></span></div>
                                    </div>
                                </div>
                                Avatar<br><small>Si consiglia di caricare un immagine in PNG con sfondo trasparente (dimensione massima 100 KB)</small>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <button type="submit" class="btn btn-primary"><i class="fas fa-save mr-1"></i>Insert</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script>
    ...
    function beforesubmit(){
        ...
        var velement = [];
        if($('#name').val() == ""){
            validation.push('Username non valorizzato');
            velement.push($('#name'));
        }
        if($('#email').val() == ""){
            validation.push('Email non valorizzato');
            velement.push($('#email'));
        }
        if($('#friendly_name').val() == ""){
            validation.push('Nome non valorizzato');
