							...
							<div class="topbar">
								...
								<div class="dropdown mr-1" id="kt_quick_search_toggle">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
										<div class="quick-search quick-search-dropdown">
											<!--begin:Form-->
											<form method="get" id="form-search" class="quick-search-form">
												<div class="input-group">
													...
													<input type="text" class="form-control" id="search-q" placeholder="Cerca cliente, asset, IP pubblico o DN" />
								...
								<div class="topbar-item ml-4">
									<div class="btn btn-icon btn-light-primary h-40px w-40px p-0" id="kt_quick_user_toggle">
										@if(Auth::user()->avatar)
											<img src="{{ Auth::user()->avatar }}" class="h-30px align-self-end" alt="" />
                                    	@else
