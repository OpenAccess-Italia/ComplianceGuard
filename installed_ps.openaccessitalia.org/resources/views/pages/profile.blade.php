        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Profile {{\Auth::user()->friendly_name}} (Username: {{\Auth::user()->name}})</h5>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="name" id="name" autocomplete="none" value="{{\Auth::user()->name}}" placeholder="Username" disabled>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="email" class="form-control" name="email" id="email" autocomplete="none" value="{{\Auth::user()->email}}" placeholder="Email" disabled>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="friendly_name" id="friendly_name" autocomplete="none" value="{{\Auth::user()->friendly_name}}" placeholder="Name">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <h3 class="font-size-lg text-dark font-weight-bold mb-6">Permessi</h3>
                                        <div class="form-row mt-3">
                                            <div class="col-md-2 text-center">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="piracy" name="piracy" @if(\Auth::user()->piracy) checked @endif disabled>
                                            ...
                                            <div class="col-md-2 text-center">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="cncpo" name="cncpo" @if(\Auth::user()->cncpo) checked @endif disabled>
                                            ...
                                            <div class="col-md-2 text-center">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="adm" name="adm" @if(\Auth::user()->adm) checked @endif disabled>
                                            ...
                                            <div class="col-md-2 text-center">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="manual" name="manual" @if(\Auth::user()->manual) checked @endif disabled>
                                            ...
                                            <div class="col-md-2 text-center">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="admin" name="admin" @if(\Auth::user()->admin) checked @endif disabled>
                                            ...
                                            <div class="col-md-2 text-center">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="enabled" name="enabled" @if(\Auth::user()->enabled) checked @endif disabled>
                            ...
                            <div class="col-md-3 text-center">
                                ...
                                <div class="image-input image-input-outline text-center w-100" id="avatar_container">
                                    @if(\Auth::user()->avatar)
                                        <div class="image-input-wrapper w-100" style="height: 276px;background-color: lightgrey;background-image:url({{\Auth::user()->avatar}})" id="avatar_preview"></div>
                                    @else
